...
│
├── Main_v9_Plots/                         # ERP, PSD, confusion matrices plots generated by Main execution script v9
│   ├── preprocessing_comparison_*.png
│   └── erp_comparison_*.png
│   └── ... (regenerated when code runs)
│
├── Main_v9_final_results/                  # JSON summaries, test results, etc generated by Main execution script v9
